<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ywqz.aspx.cs" Inherits="ywqz" %>
...
<body  style="background-image: url('images/a.jpg')">
    ...
    <div id="ywqz">
        ...
        <table class="style1">
            <tr>
                <td class="style2">
                    <asp:Label ID="Label1" runat="server" ForeColor="White" Text="请输入俯卧撑个数："></asp:Label>
                </td>
                <td>
            ...
            <tr>
                <td class="style2">
                    <asp:Label ID="Label2" runat="server" ForeColor="White" Text="你的年龄："></asp:Label>
                </td>
                <td>
            ...
            <tr>
                <td class="style2">
                    <asp:Label ID="Label3" runat="server" ForeColor="White" Text="特别提醒："></asp:Label>
                </td>
                <td>
